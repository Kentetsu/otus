...
def test_add_area_no_figure(default_figures):
    with pytest.raises(ValueError):
        default_figures[0].add_area(1)
    with pytest.raises(ValueError):
        default_figures[1].add_area(1)
    with pytest.raises(ValueError):
        default_figures[2].add_area(1)
    with pytest.raises(ValueError):
        default_figures[3].add_area(1)
